...
<div class="log_bg">	
	...
	<div class="regist">
		...
		<div class="reg_c">
        	<form method="post" action="UserService?action=regist">
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;用户id &nbsp;</td>
                <td><input type="text" value="" class="l_user"  name="loginName"/></td>
              </tr>
                <tr height="50">
                    <td align="right">用户名 &nbsp;</td>
                    <td><input type="text" value="" class="l_mem"  name="userName"/></td>
                </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="password" value="" class="l_pwd" name="affirm" /></td>
              </tr>
              <tr height="50">
